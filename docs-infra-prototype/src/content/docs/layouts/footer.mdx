...
const sections = [
  {
    title: "Resources",
    links: [
      { title: "GitHub", href: "https://github.com/yourrepo", external: true },
      { title: "Status Page", href: "https://status.yoursite.com", external: true }
    ]
  }
];
```
...
<Footer companyName="Your Company">
  <div class="custom-footer-content">
    ...
    <a href="/docs-site-kickstarter/terms" class="cta-link">Terms of Service</a>
  </div>
</Footer>
```
