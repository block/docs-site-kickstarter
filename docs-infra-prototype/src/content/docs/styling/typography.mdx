...
<Tabs defaultValue="h1">
  ...
  <TabsContent value="h1">
    <div class="pl-6 pr-6">
      <h1 class="font-sans text-5xl font-black leading-none mt-8 mb-6 scroll-m-20 tracking-tight">Heading 1 (`h1`)</h1>
  ...
  <TabsContent value="h2">
    <div class="pl-6 pr-6">
      <h2 class="font-sans text-3xl font-semibold leading-relaxed border-b pb-2 mt-8 mb-6 scroll-m-20 tracking-tight">Heading 2 (`h2`)</h2>
      ...
      <Accordion label="CSS Properties for H2">
        <AccordionContent>
          ...
          | `border-bottom` | `1px solid` theme border | `border-b` |
  ...
  <TabsContent value="h3">
    <div class="pl-6 pr-6">
      <h3 class="font-sans text-2xl font-semibold leading-8 mt-8 mb-4 scroll-m-20 tracking-tight">Heading 3 (`h3`)</h3>
  ...
  <TabsContent value="h4">
    <div class="pl-6 pr-6">
      <h4 class="font-sans text-xl font-semibold leading-7 mt-6 mb-4 scroll-m-20 tracking-tight">Heading 4 (`h4`)</h4>
  ...
  <TabsContent value="h5">
    <div class="pl-6 pr-6">
      <h5 class="font-sans text-lg font-medium leading-7 mt-6 mb-4 scroll-m-20 tracking-tight">Heading 5 (`h5`)</h5>
  ...
  <TabsContent value="h6">
    <div class="pl-6 pr-6">
      <h6 class="font-sans text-base font-semibold leading-6 mt-6 mb-4 scroll-m-20 tracking-tight">Heading 6 (`h6`)</h6>
